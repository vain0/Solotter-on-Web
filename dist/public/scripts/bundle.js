...
const H = __importStar(__webpack_require__(/*! history */ "./node_modules/history/es/index.js"));
const utils_1 = __webpack_require__(/*! ../utils */ "./src/utils.ts");
const universal_router_1 = __importDefault(__webpack_require__(/*! universal-router */ "./node_modules/universal-router/module.js"));
const exhaust = (x) => x;
const initState = {
    pathname: '/sign',
    area: 'sign',
...
const toSignMail = (state) => utils_1.merge(state, { area: 'sign', sign: { phase: 'mail' } });
const toSignPassword = (state) => utils_1.merge(state, { area: 'sign', sign: { phase: 'password' } });
...
const router = new universal_router_1.default([
    ...
    resolveRoute(context) {
        ...
        return r && utils_1.merge(context.state, r);
    },
});
const resolveRoute = (state) => __awaiter(this, void 0, void 0, function* () {
    ...
    if (path === '/') {
        return utils_1.merge(state, { area: 'edit' });
    }
    throw '404';
});
const reverseRoute = (state) => {
...
const setMail = (mail) => (state) => __awaiter(this, void 0, void 0, function* () {
    return utils_1.merge(state, { sign: { mail } });
});
const setPassword = (password) => (state) => __awaiter(this, void 0, void 0, function* () {
    return utils_1.merge(state, { sign: { password } });
});
const advance = (state) => __awaiter(this, void 0, void 0, function* () {
    const phase = state.sign.phase;
    if (phase === 'mail') {
        console.log({ 'mail to password': state });
        return utils_1.merge(state, { sign: { phase: 'password' } });
    }
    else if (phase === 'password') {
        console.log({ 'password to edit': state });
        return utils_1.merge(state, { auth: true, area: 'edit' });
    }
    else {
        return exhaust(phase);
    }
});
const renderSign = (state, sink) => {
    const renderContent = () => {
        const { sign: { mail, password, phase } } = state;
        if (phase === 'mail') {
            return (React.createElement("section", null,
                React.createElement("label", null, "Mail Address"),
                React.createElement("input", { key: 'mail-input', type: 'email', value: mail, onChange: ev => sink(setMail(ev.target.value)) })));
        }
        else if (phase === 'password') {
            return React.createElement("section", null,
                React.createElement("label", null, "Password"),
                React.createElement("input", { key: 'password-input', type: 'password', value: password, onChange: ev => sink(setPassword(ev.target.value)) }));
        }
        else {
            return exhaust(phase);
        }
    };
    return (React.createElement("article", { key: 'sign-component' },
        React.createElement("h2", null, "Sign"),
        React.createElement("form", { onSubmit: ev => { ev.preventDefault(); sink(advance); } },
            renderContent(),
...
class AppRootComponent extends React.Component {
    ...
    updateState(nextState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const updated = yield nextState(prevState);
            const reversed = Object.assign({}, updated, { pathname: reverseRoute(updated) });
            const state = yield resolveRoute(reversed);
    ...
    componentDidMount() {
        ...
        (() => __awaiter(this, void 0, void 0, function* () {
            const givenState = Object.assign({}, (history.location.state || {}), this.state, { pathname: history.location.pathname });
            const resolved = yield resolveRoute(givenState);
            const state = Object.assign({}, resolved, { pathname: reverseRoute(resolved) });
    ...
    render() {
        ...
        const sink = (nextState) => this.updateState(nextState);
        if (area === 'sign') {
            return renderSign(this.state, sink);
        }
        else if (area === 'edit') {
            return (React.createElement("span", null, " Edit page. "));
        }
        else {
            return exhaust(area);
        }
...
const main = () => {
    ...
    ReactDOM.render(React.createElement(AppRootComponent, { history: history }), document.getElementById('app'));
};
main();
...
/***/ 0:
/*!**********************************!*\
  !*** multi ./src/client/app.tsx ***!
  \**********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! ./src/client/app.tsx */"./src/client/app.tsx");
